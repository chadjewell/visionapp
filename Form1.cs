...
namespace VisionApp
{
    ...
    {
        string[] names = { "IS2000-640", "IS2000-800", "IS7800-640", "IS7800-800", "IS7801 | IS3801", "IS7802", "IS7902", "IS7902P", "IS3803", "IS7905 | D905 | IS3805", "IS3808", "IS9912", "IS3812", "IS3816", "DM260", "DM262", "DM360", "DM362", "DM363", "DM374", "DM375", "DM474", "DM475" };
        double[] lengthS = { 2.4, 3, 2.88, 3.6, 5.76, 7.2, 5.52, 6.62, 7.065, 8.445, 7.781, 14.131, 11.223, 14.576, 4.512, 4.8, 3.6, 5.76, 7.2, 7.065, 8.4456, 7.065, 8.4456};
        double[] lengthP = { 640, 800, 640, 800, 1280, 1600, 1600, 1920, 2048, 2448, 2840, 4096, 4096, 5320, 752, 1280, 800, 1280, 1600, 2048, 2448, 2048, 2448 };
